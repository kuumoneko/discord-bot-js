...
const { discordClient, join_voice, leave_voice, now_playing, pausing, play_music, see_queue,
    resuming, set_loop, shuffling, skipping, stopping } = require('../../index');
...
module.exports = {
    ...
    async execute(client, interaction) {
        ...
        if (scm === 'join') {
            ...
            await play_music(client, interaction, prompts, isloop, shuffle, mode).then(data => {
                result = data
            });
        }
        else if (scm === 'queue') {
